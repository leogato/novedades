...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-10-2013 a las 01:41:28
...
ALTER TABLE `empleado`
  ADD CONSTRAINT `empleado_ibfk_1` FOREIGN KEY (`COD_SUC`) REFERENCES `sucursal` (`cod_suc`) ON DELETE CASCADE ON UPDATE CASCADE;
