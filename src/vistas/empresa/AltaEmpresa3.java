 ...
 * @author usuario
 */
public class AltaEmpresa3 extends javax.swing.JDialog {
    Empresa e = null;
    /**
     * Creates new form AltaEmpresa3
     */
    public AltaEmpresa3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//            txtFecIni.setText(e.getFechaInicio());
    ...
    private void initComponents() {
        ...
        panel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 102, 0), 2, true), "ALTA, BAJA Y MODIFICACION DE EMPRESAS", 2, 0, new java.awt.Font("Calibri", 1, 24), java.awt.Color.white)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltaEmpresa3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AltaEmpresa3 dialog = new AltaEmpresa3(new javax.swing.JFrame(), true);
