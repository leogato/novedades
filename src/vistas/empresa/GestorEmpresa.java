 ...
 * @author Joel
 */
public class GestorEmpresa extends javax.swing.JDialog {
  ...
  //  EmpleadoDao empleados ;
    ...
    public GestorEmpresa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
        initComponents();
        initComponentesVentana();    
        this.setTitle("MODIFICACION DE EMPRESA");
        setLocationRelativeTo(this);
        setVisible(true);
        
        
    }
    public GestorEmpresa(java.awt.Frame parent, boolean modal,int quienloyamo) {
        super(parent, modal);
        this.parent = parent;
    ...
    private void initComponents() {
        ...
        tblEmpresa.setBackground(new java.awt.Color(204, 204, 204));
        tblEmpresa.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        tblEmpresa.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "CODIGO", "DENOMINACION", "GERENTE", "MAIL", "ESTADO"
            }
        ) {
...
//        isModificar= true;
        int fila = tblEmpresa.getSelectedRow();
        if (fila!= -1) {
            codigo = (Integer) tblEmpresa.getModel().getValueAt(tblEmpresa.getSelectedRow(), 0);
            //LLAMAR A A LA VENTANA NUEVO EMPLEADO PARA EDITAR
            AltaEmpresa ventanaEditEmpresa = new AltaEmpresa(parent, true, codigo);
            cargarTablaConEmpresa();    
        }else{
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        AltaEmpresa ventanaNuevoEmpresa = new AltaEmpresa(parent, true);
            cargarTablaConEmpresa();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestorEmpresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GestorEmpresa dialog = new GestorEmpresa(new javax.swing.JFrame(), true);
     ...
     */
    private void cargarTablaConEmpresa() {
       listaEmpresa =new EmpresaDaoImp().listarEmpresa();
       util.TablaUtil.prepararTablaEmpresa(modelo, tblEmpresa);
       util.TablaUtil.cargarModeloEmpresa(modelo, listaEmpresa, tblEmpresa);
    }

    private List<Empresa> filtrarPorNombreEmpresa(List<Empresa> listaEmpresa, String text) {
         List<Empresa> list = new ArrayList<Empresa>();
         
         for (Empresa empresa : listaEmpresa) {
             if (empresa.getNombre().contains(text)) {
                 list.add(empresa);
             }
        }
    ...
    private List<Empresa> filtrarPorLegajoEmpresa(List<Empresa> listaEmpresa, String text) {
         List<Empresa> list = new ArrayList<Empresa>();
         
         for (Empresa empresa : listaEmpresa) {
             if (String.valueOf(empresa.getCodEmp()).contains(text)) {
                 list.add(empresa);
             }
        }
